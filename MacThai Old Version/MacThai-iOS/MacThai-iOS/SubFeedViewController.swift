...
class SubFeedViewController: UITableViewController, NSXMLParserDelegate {
    ...
    */
    ...
    func parserDidEndDocument(parser: NSXMLParser) {
        if let titleComponents = self.feedTitle?.componentsSeparatedByString(" ") {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if identifier == "ToBrowser" {
            ...
            if sender is NSIndexPath {
                let sen = sender as! NSIndexPath
                let data: [NSObject: AnyObject] = self.feeds[sen.row]
